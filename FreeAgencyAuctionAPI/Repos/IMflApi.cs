...
namespace FreeAgencyAuctionAPI.Repos
{
    ...
    public interface IMflApi
    {
        ...
        Task<HttpResponseMessage> AdjustPlayerSalary([Path] int leagueId, [Body(BodySerializationMethod.UrlEncoded)] Dictionary<string, string> data, [Path] int year = Utils.ThisYear);
